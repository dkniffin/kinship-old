class PeopleController < ApplicationController
  ...
  private
    ...
    def person_params
      params.require(:person).permit(:first_name, :last_name, :gender, :photo, birth_attributes: [:date, :place_id, :father_id, :mother_id], death_attributes: [:dead, :date, :place_id, :cause])
    end
end
