  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved place as @place" do
        ...
        post :create, {:place => { "country" => "invalid value" }}, valid_session
        assigns(:place).should be_a_new(Place)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested place" do
        ...
        Place.any_instance.should_receive(:update).with({ "country" => "MyString" })
        put :update, {:id => place.to_param, :place => { "country" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the place as @place" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Place.any_instance.stub(:save).and_return(false)
        put :update, {:id => place.to_param, :place => { "country" => "invalid value" }}, valid_session
        assigns(:place).should eq(place)
      end
