...
robb = Person.create(:first_name => 'Robb', :last_name => 'Stark', :gender => 'M', :spouse_id => jeyne.id, :birth => Birth.create(:father_id => eddard.id, :mother_id => catelyn.id), :death => Death.create(:dead => true, :date => '299-01-01', :cause => 'The Red Wedding'))
